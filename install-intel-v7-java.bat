...
set download_path="./jre-7u80-windows-i586.exe"
...
powershell -command "(New-Object System.Net.WebClient).DownloadFile('https://storage.googleapis.com/online-video-downloader-410712.appspot.com/jre-7u80-windows-i586.exe', '%download_path%')"
...
@REM C:\Program Files (x86)\Java\jre7\bin

setx JAVA_HOME "C:\Program Files (x86)\Java\jre7" /m 
...
setx PATH "%PATH%;C:\Program Files (x86)\Java\jre7\bin" /m
